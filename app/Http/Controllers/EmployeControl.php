...
class EmployeControl extends Controller
{
   ...
   //liste de tous les employes "fiche technique"
    ...
    {
       // dd($id);
        $detailemp=DB::table('employe')->join('travaill','travaill.ID_NIN','=','employe.ID_NIN')
                                       ->join('departement','travaill.ID_D',"=","departement.ID_D")
                                       ->join('post','post.ID_NIN','=','employe.ID_NIN')
                                       ->join('appartient','appartient.ID_NIN','=','employe.ID_NIN')
                                        ->join('niveau','niveau.ID_N','=','appartient.ID_N')
                                        ->where('employe.ID_NIN',$id)
                                        ->get();
